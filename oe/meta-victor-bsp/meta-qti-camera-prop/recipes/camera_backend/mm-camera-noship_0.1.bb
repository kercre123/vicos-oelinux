...
SRCREV = "${AUTOREV}"
S      = "${WORKDIR}/camera/mm-camera-noship"
...
export TARGET_LIBRARY_SUPPRESS_LIST="libcamera_client libhardware \
        ...
        libbinder libgui libstlport libandroid libxml2 libz libstdc++ libfastcvopt"
...
do_compile () {
    ...
    if [ "${MLPREFIX}" == "lib32-" ] || [ "${MLPREFIX}" == "" -a "${TUNE_ARCH}" == "arm" ]; then
        ...
        export MMCAMERACORE_PATH='$(QC_PROP_ROOT)'/mm-camera-core
        export MM3ACORE_PATH='$(QC_PROP_ROOT)'/mm-3a-core
        ...
        export BUILD_3A_TOOLS=false
        export TARGET_SCVE_DISABLED=true
        export EIS_DG_PREBUILT=true
