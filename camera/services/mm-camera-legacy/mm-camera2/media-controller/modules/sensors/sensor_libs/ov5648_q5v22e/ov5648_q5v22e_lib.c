...
#define SENSOR_MODEL_NO_OV5648_Q5V22E "ov5648_q5v22e"
#define OV5648_Q5V22E_LOAD_CHROMATIX(n) \
  "libchromatix_"SENSOR_MODEL_NO_OV5648_Q5V22E"_"#n".so"

#undef DEBUG_INFO
#define OV5648_Q5V22E_DEBUG
#ifdef OV5648_Q5V22E_DEBUG
#include <utils/Log.h>
...
static struct msm_camera_csid_vc_cfg ov5648_q5v22e_cid_cfg[] = {
...
static struct msm_camera_csi2_params ov5648_q5v22e_csi_params = {
  .csid_params = {
    ...
    .lut_params = {
      ...
      .vc_cfg = {
         &ov5648_q5v22e_cid_cfg[0],
         &ov5648_q5v22e_cid_cfg[1],
      },
    },
  },
  .csiphy_params = {
...
static struct sensor_pix_fmt_info_t ov5648_q5v22e_pix_fmt0_fourcc[] = {
  { V4L2_PIX_FMT_SBGGR10 },
};

static struct sensor_pix_fmt_info_t ov5648_q5v22e_pix_fmt1_fourcc[] = {
  { MSM_V4L2_PIX_FMT_META },
};

static sensor_stream_info_t ov5648_q5v22e_stream_info[] = {
  {1, &ov5648_q5v22e_cid_cfg[0], ov5648_q5v22e_pix_fmt0_fourcc},
  {1, &ov5648_q5v22e_cid_cfg[1], ov5648_q5v22e_pix_fmt1_fourcc},
};

static sensor_stream_info_array_t ov5648_q5v22e_stream_info_array = {
  .sensor_stream_info = ov5648_q5v22e_stream_info,
  .size = ARRAY_SIZE(ov5648_q5v22e_stream_info),
};
...
static struct msm_camera_csi2_params *csi_params[] = {
  &ov5648_q5v22e_csi_params, /* RES 0*/
  &ov5648_q5v22e_csi_params, /* RES 1*/
};
...
static sensor_res_cfg_type_t ov5648_q5v22e_res_cfg[] = {
...
static struct sensor_res_cfg_table_t ov5648_q5v22e_res_table = {
  .res_cfg_type = ov5648_q5v22e_res_cfg,
  .size = ARRAY_SIZE(ov5648_q5v22e_res_cfg),
};

static struct sensor_lib_chromatix_t ov5648_q5v22e_chromatix[] = {
  {
    .common_chromatix = OV5648_Q5V22E_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = OV5648_Q5V22E_LOAD_CHROMATIX(zsl), /* RES0 */
    .camera_snapshot_chromatix = OV5648_Q5V22E_LOAD_CHROMATIX(snapshot), /* RES0 */
    .camcorder_chromatix = OV5648_Q5V22E_LOAD_CHROMATIX(default_video), /* RES0 */
  },
  {
    .common_chromatix = OV5648_Q5V22E_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = OV5648_Q5V22E_LOAD_CHROMATIX(preview), /* RES2 */
    .camera_snapshot_chromatix = OV5648_Q5V22E_LOAD_CHROMATIX(preview), /* RES2 */
    .camcorder_chromatix = OV5648_Q5V22E_LOAD_CHROMATIX(default_video), /* RES2 */
  },
};

static struct sensor_lib_chromatix_array ov5648_q5v22e_lib_chromatix_array = {
  .sensor_lib_chromatix = ov5648_q5v22e_chromatix,
  .size = ARRAY_SIZE(ov5648_q5v22e_chromatix),
};

/*===========================================================================
 * FUNCTION    - ov5648_q5v22e_real_to_register_gain -
 *
 * DESCRIPTION:
 *==========================================================================*/
static uint16_t ov5648_q5v22e_real_to_register_gain(float gain)
{
...
/*===========================================================================
 * FUNCTION    - ov5648_q5v22e_register_to_real_gain -
 *
 * DESCRIPTION:
 *==========================================================================*/
static float ov5648_q5v22e_register_to_real_gain(uint16_t reg_gain)
{
  float real_gain;
...
/*===========================================================================
 * FUNCTION    - ov5648_q5v22e_calculate_exposure -
 *
 * DESCRIPTION:
 *==========================================================================*/
static int32_t ov5648_q5v22e_calculate_exposure(float real_gain,
  uint16_t line_count, sensor_exposure_info_t *exp_info)
{
  if (!exp_info) {
    return -1;
  }
  exp_info->reg_gain = ov5648_q5v22e_real_to_register_gain(real_gain);
  float sensor_real_gain = ov5648_q5v22e_register_to_real_gain(exp_info->reg_gain);
...
/*===========================================================================
 * FUNCTION    - ov5648_q5v22e_fill_exposure_array -
 *
 * DESCRIPTION:
 *==========================================================================*/
static int32_t ov5648_q5v22e_fill_exposure_array(uint16_t gain, uint32_t line,
...
static sensor_exposure_table_t ov5648_q5v22e_expsoure_tbl = {
  .sensor_calculate_exposure = ov5648_q5v22e_calculate_exposure,
  .sensor_fill_exposure_array = ov5648_q5v22e_fill_exposure_array,
};
...
//   .eeprom_name = "sunny_q5v22e",
  ...
  /* csi cid params */
  .csi_cid_params = ov5648_q5v22e_cid_cfg,
  /* csi csid params array size */
  .csi_cid_params_size = ARRAY_SIZE(ov5648_q5v22e_cid_cfg),
  /* init settings */
  ...
  .sensor_res_cfg_table = &ov5648_q5v22e_res_table,
  /* res settings */
  ...
  .sensor_stream_info_array = &ov5648_q5v22e_stream_info_array,
  /* exposure funtion table */
  .exposure_func_table = &ov5648_q5v22e_expsoure_tbl,
  /* chromatix array */
  .chromatix_array = &ov5648_q5v22e_lib_chromatix_array,
};

/*===========================================================================
 * FUNCTION    - ov5648_q5v22e_open_lib -
 *
 * DESCRIPTION:
 *==========================================================================*/
void *ov5648_q5v22e_open_lib(void)
{
