...
/**
* @brief  Update Batch Start time request
*
* @param  qdr_storage_t Requested Data ID will
*                 delete from file system.
*
...
*
*/
typedef int (* dr_updatestartbatchtime_callback_t)(uint64_t dr_dispatchtime_ms);
...
typedef struct {
    ...
    dr_updatestartbatchtime_callback_t dr_update_start_batchtime_cb;
}dr_callbacks_t;
