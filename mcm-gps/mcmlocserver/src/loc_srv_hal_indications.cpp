//=============================================================================
// FILE: loc_srv_hal_indications.c
//
// DESCRIPTION:
// Implementation of HAL Callbacks/Indication functions
//
...
/*  but  gps.h declares a function which returns just a void. */
...
//       void
//=============================================================================
void loc_srv_location_ind (LocGpsLocation *location){
...
//       void
//=============================================================================
void loc_srv_sv_status_ind (LocGpsSvStatus *sv_info){

    LOC_SRV_LOGI("<MCM_LOC_SVC> HAL Indication Function:%s",__func__);
    if(loc_srv_check_sv_ind_registration()) {
        loc_srv_send_sv_status_ind(sv_info);
    }
}
...
//       void
//=============================================================================
void loc_srv_nmea_ind (LocGpsUtcTime timestamp, const char* nmea, int length){

    LOC_SRV_LOGI("<MCM_LOC_SVC> HAL Indication Function:%s",__func__);
    if(loc_srv_check_nmea_ind_registration()) {
        loc_srv_send_nmea_ind(timestamp, nmea, length);
    }
}
...
//       void
//=============================================================================
void loc_srv_gps_ni_ind (LocGpsNiNotification *notification, bool esEnabled){

    LOC_SRV_LOGI("<MCM_LOC_SVC> HAL Indication Function:%s",__func__);
    if(loc_srv_check_ni_ind_registration()) {
        loc_srv_send_gps_ni_ind(notification);
    }
}
