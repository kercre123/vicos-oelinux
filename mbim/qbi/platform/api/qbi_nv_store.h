...
typedef enum {
  ...
  @details This NV maintains Executor to slot mapping configuration. For MultiSIM
  use cases when the mapping of executor to slot for first boot, slot status info,
  streaming of APDUs and slot mapping is based on this item */
  QBI_NV_STORE_CFG_ITEM_EXECUTOR_SLOT_CONFIG = 9,
