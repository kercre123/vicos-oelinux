...
/*-------------------------------------------------------------------------*/
  ...
  qmi_req->route_list_tuple[1].route_storage  = 
    (cache->configuration.storage_pref == WMS_STORAGE_TYPE_UIM_V01) 
    ? WMS_STORAGE_TYPE_UIM_V01 : WMS_STORAGE_TYPE_NV_V01;
  qmi_req->route_list_tuple[1].receipt_action = WMS_STORE_AND_NOTIFY_V01;
  ...
  qmi_req->route_list_tuple[3].route_storage  = 
    (cache->configuration.storage_pref == WMS_STORAGE_TYPE_UIM_V01) 
    ? WMS_STORAGE_TYPE_UIM_V01 : WMS_STORAGE_TYPE_NV_V01;
  qmi_req->route_list_tuple[3].receipt_action = WMS_STORE_AND_NOTIFY_V01;
  ...
  qmi_req->route_list_tuple[4].route_storage  = 
    (cache->configuration.storage_pref == WMS_STORAGE_TYPE_UIM_V01) 
    ? WMS_STORAGE_TYPE_UIM_V01 : WMS_STORAGE_TYPE_NV_V01;
  qmi_req->route_list_tuple[4].receipt_action = WMS_STORE_AND_NOTIFY_V01;
  ...
  qmi_req->route_list_tuple[5].route_storage  = 
    (cache->configuration.storage_pref == WMS_STORAGE_TYPE_UIM_V01) 
    ? WMS_STORAGE_TYPE_UIM_V01 : WMS_STORAGE_TYPE_NV_V01;
  qmi_req->route_list_tuple[5].receipt_action = WMS_STORE_AND_NOTIFY_V01;
...
/*-------------------------------------------------------------------------*/
  ...
  else
  {
    action = qbi_svc_sms_send_s_write(
      txn, qbi_svc_sms_configuration_get_preferred_storage_type(txn->ctx));
  }
...
/*-------------------------------------------------------------------------*/
  ...
  else
  {
    ...
    /* Change the tag of the stored message from MO_NOT_SENT to MO_SENT */
    qbi_svc_sms_modify_tag(
      qmi_txn->ctx, info->storage_type, info->index, WMS_TAG_TYPE_MO_SENT_V01);
