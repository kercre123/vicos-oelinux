...
/*===========================================================================
FUNCTION: qbi_svc_bc_ext_dssa_open_configure_qmi_inds
===========================================================================*/
/*!
...
*/
/*=========================================================================*/
qbi_svc_action_e qbi_svc_bc_ext_dssa_open_configure_qmi_inds
(
  qbi_txn_s *txn
)
{
...
} /* qbi_svc_bc_ext_dssa_open_configure_qmi_inds() */
...
/*-------------------------------------------------------------------------*/
  ...
  else
  {
    ...
    exec_slot_cfg.exec0_slot = req_slot;
    ...
    {
      QBI_LOG_E_0("DSSA:Couldn't save new switched slot to NV!");
    }
    else
    {
...
/*-------------------------------------------------------------------------*/
  ...
  if (!qbi_nv_store_cfg_item_read(
    ...
    &exec_slot_cfg, sizeof(qbi_svc_bc_ext_exec_slot_config_s)))
    {
    QBI_LOG_E_0("DSSA:Unable to read executor_slot_config NV");
    }
  else
    {
    exec_slot_cfg.exec0_slot = req_slot;
