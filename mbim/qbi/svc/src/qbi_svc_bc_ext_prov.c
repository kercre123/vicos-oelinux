...
/*===========================================================================
  FUNCTION: qbi_svc_bc_ext_prov_ctx_cache_get
===========================================================================*/
/*!
...
*/
/*=========================================================================*/
qbi_svc_bc_ext_cache_s *qbi_svc_bc_ext_prov_ctx_cache_get
(
  qbi_ctx_s *ctx,
...
} /* qbi_svc_bc_ext_prov_ctx_cache_get() */
...
/*-------------------------------------------------------------------------*/
  while (QMI_WDS_PROFILE_LIST_MAX_V01 > cache_index)
  {
    cache = (qbi_svc_bc_ext_cache_s *)
        qbi_svc_bc_ext_prov_ctx_cache_get(ctx, cache_index);
    if (cache == NULL)
    {
...
/*-------------------------------------------------------------------------*/
  ...
  cache = (qbi_svc_bc_ext_cache_s *)
      qbi_svc_bc_ext_prov_ctx_cache_get(qmi_txn->ctx, *profile_index);
  QBI_CHECK_NULL_PTR_RET_ABORT(cache);
...
/*-------------------------------------------------------------------------*/
  ...
  else
  {
    ...
    if (setsel_ind->ind_token_valid == TRUE && setsel_ind->ind_token == PROV_V2_IND_TOKEN)
    {
      ...
      qmi_req_pdc27->slot_id = qbi_svc_bc_sim_get_logical_slot();
      action = QBI_SVC_ACTION_SEND_QMI_REQ;
    }
  }
...
/*-------------------------------------------------------------------------*/
  ...
  else
  {
    ...
    if (deact_ind->ind_token_valid == TRUE && deact_ind->ind_token == PROV_V2_IND_TOKEN)
    {
      ...
      qmi_req_pdc23->slot_id = qbi_svc_bc_sim_get_logical_slot();
...
*/
/*=========================================================================*/
qbi_svc_bc_ext_cache_s* qbi_svc_bc_ext_prov_ctx_v2_update_cache
(
  qbi_txn_s *txn,
  const wds_get_profile_settings_resp_msg_v01 *qmi_rsp
)
...
/*-------------------------------------------------------------------------*/
  ...
  cache = qbi_svc_bc_ext_prov_ctx_cache_get(txn->ctx,
                                   info->profile_list.profile_index[info->profiles_read]);
...
/*-------------------------------------------------------------------------*/
  ...
  {
    // update cache
    cache = qbi_svc_bc_ext_prov_ctx_cache_get(
...
/*-------------------------------------------------------------------------*/
  ...
  else
  {
    ...
    qmi_req_pdc22->slot_id = qbi_svc_bc_sim_get_logical_slot();
...
/*-------------------------------------------------------------------------*/
  ...
  {
    cache = qbi_svc_bc_ext_prov_ctx_cache_get(qmi_txn->ctx, qmi_req->profile.profile_index);
    QBI_CHECK_NULL_PTR_RET_ABORT(cache);
