...
/*-------------------------------------------------------------------------*/
  ...
  cache = qbi_svc_bc_ext_prov_ctx_cache_get(qmi_txn->parent->ctx,
...
/*-------------------------------------------------------------------------*/
  ...
  {
    cache = qbi_svc_bc_ext_prov_ctx_cache_get(txn->ctx, i);
...
/*-------------------------------------------------------------------------*/
  ...
  for (i = 0; i < QMI_WDS_PROFILE_LIST_MAX_V01; i++)
  {
    cache = qbi_svc_bc_ext_prov_ctx_cache_get(qmi_txn->ctx, i);
    QBI_CHECK_NULL_PTR_RET_FALSE(cache);
