...
{
    mcm_srv_adaptor_post_response(req_handle,msg_id, resp_c_struct, resp_c_struct_len);
}
...
{
    mcm_srv_adaptor_post_indication(client_handle, msg_id, ind_c_struct, ind_c_struct_len);
}
