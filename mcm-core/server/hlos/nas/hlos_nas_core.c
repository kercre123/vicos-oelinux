                                    ...
                                    void *reg_info)
{
    ...
    switch(rte)
    {
        case CRI_NAS_RTE_CDMA:
            ...
            strlcpy(hlos_3gpp2_reg_info->mcc,cdma_voice_reg_info->reg_info.mcc,CRI_NAS_MCC_MNC_MAX);
            strlcpy(hlos_3gpp2_reg_info->mnc,cdma_voice_reg_info->reg_info.mnc,CRI_NAS_MCC_MNC_MAX);
            hlos_3gpp2_reg_info->roaming = cdma_voice_reg_info->reg_info.roam_status;
            hlos_3gpp2_reg_info->forbidden = NIL;
            hlos_3gpp2_reg_info->inPRL = NIL;
        ...
        case CRI_NAS_RTE_HDR:
            ...
            strlcpy(hlos_3gpp2_reg_info->mcc,hdr_voice_reg_info->reg_info.mcc,CRI_NAS_MCC_MNC_MAX);
            strlcpy(hlos_3gpp2_reg_info->mnc,hdr_voice_reg_info->reg_info.mnc,CRI_NAS_MCC_MNC_MAX);
                                ...
                                void *reg_info)
{
    ...
    switch(rte)
    {
        case CRI_NAS_RTE_GSM:
            ...
            strlcpy(hlos_3gpp_reg_info->mcc,gsm_voice_reg_info->reg_info.mcc,CRI_NAS_MCC_MNC_MAX);
            strlcpy(hlos_3gpp_reg_info->mnc,gsm_voice_reg_info->reg_info.mnc,CRI_NAS_MCC_MNC_MAX);
        ...
        case CRI_NAS_RTE_WCDMA:
            ...
            strlcpy(hlos_3gpp_reg_info->mcc,wcdma_voice_reg_info->reg_info.mcc,CRI_NAS_MCC_MNC_MAX);
            strlcpy(hlos_3gpp_reg_info->mnc,wcdma_voice_reg_info->reg_info.mnc,CRI_NAS_MCC_MNC_MAX);
        ...
        case CRI_NAS_RTE_LTE:
            ...
            strlcpy(hlos_3gpp_reg_info->mcc,lte_voice_reg_info->reg_info.mcc,CRI_NAS_MCC_MNC_MAX);
            strlcpy(hlos_3gpp_reg_info->mnc,lte_voice_reg_info->reg_info.mnc,CRI_NAS_MCC_MNC_MAX);
        ...
        case CRI_NAS_RTE_TDSCDMA:
            ...
            strlcpy(hlos_3gpp_reg_info->mcc,tdscdma_voice_reg_info->reg_info.mcc,CRI_NAS_MCC_MNC_MAX);
            strlcpy(hlos_3gpp_reg_info->mnc,tdscdma_voice_reg_info->reg_info.mnc,CRI_NAS_MCC_MNC_MAX);
