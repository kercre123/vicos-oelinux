...
#define CRI_NAS_NW_STATE_INFO_IND 0x0001
#define CRI_NAS_NW_SIGNAL_INFO_IND 0x0002
#define CRI_NAS_DEVICE_STATE_INFO_IND 0x0003
#define CRI_NAS_NETWORK_TIME_IND 0x0004
#define CRI_NAS_LTE_SIB16_NETWORK_TIME_IND 0x0005
...
#define CRI_NAS_RSSI_DELTA   50
#define CRI_NAS_IO_DELTA     50
#define CRI_NAS_SNR_DELTA    50
#define CRI_NAS_SINR_DELTA   3
#define CRI_NAS_RSRP_DELTA   50
#define CRI_NAS_RSCP_DELTA   50
#define CRI_NAS_RSRQ_DELTA   50

#define CRI_NAS_SNR_THRESHOLD_ENTRIES_NUM                                   (NAS_SIG_STR_THRESHOLD_LIST_MAX_V01)
#define CRI_NAS_SNR_THRESHOLD_ENTRIES_NEG_NUM                               (6)
#define CRI_NAS_SNR_THRESHOLD_ENTRIES_NEG_START_VALUE                       (-200)
#define CRI_NAS_SNR_THRESHOLD_ENTRIES_POS_START_VALUE                       (30)
#define CRI_NAS_SNR_THRESHOLD_ENTRIES_NEG_INC_VALUE                         (40)
#define CRI_NAS_SNR_THRESHOLD_ENTRIES_POS_INC_VALUE                         (30)

#define CRI_NAS_OPERATOR_MAX_EONS_LEN (512)
#define CRI_NAS_OPERATOR_MAX_MCC_MNC_LEN (16)
#define CRI_NAS_NITZ_STR_BUF_MAX       (30)
