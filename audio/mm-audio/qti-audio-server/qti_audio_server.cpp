...
int32_t qti_audio_server::onTransact(uint32_t code,
    ...
    switch(code) {
        ...
        case CREATE_AUD_PATCH: {
            ...
            memscpy((void *) &sources, blob_size, blob.data(), blob_size);
            ...
            memscpy((void *) &sinks, blob_size, blob.data(), blob_size);
            blob.release();
        ...
        case GET_AUD_PORT: {
            ...
            memscpy(&port, blob_size, blob.data(), blob_size);
            blob.release();
            ...
            reply->writeBlob(size, false, &write_blob);
        ...
        case SET_AUD_PORT_CFG: {
            ...
            memscpy((void *) &cfg, blob_size, blob.data(), blob_size);
            blob.release();
        ...
        case EFFECT_COMMAND: {
            ...
            reply->writeBlob(reply_size, false, &w_blob);
