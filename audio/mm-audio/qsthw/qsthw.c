...
static bool is_valid_qsthw_module_l(qsthw_module_t *qsthw_module)
{
...
static qsthw_module_t *get_qsthw_module_l(const char *module_id)
{
    struct listnode *node, *temp_node;
    qsthw_module_t *module;
...
static int qsthw_close_l(const qsthw_module_handle_t *mod_handle)
{
    ...
    if (is_valid_qsthw_module_l(qsthw_module)) {
...
static qsthw_module_handle_t *qsthw_open_l(const char* qsthw_module_id)
{
    ...
    if (qsthw_client_cnt != 0) {
        qsthw_module = get_qsthw_module_l(qsthw_module_id);
        if (qsthw_module) {
...
int qsthw_get_version_l() {
    return QSTHW_MODULE_API_VERSION_CURRENT;
}

qsthw_module_handle_t *qsthw_load_module_l(const char *hw_module_id)
{
    return qsthw_open_l(hw_module_id);
}

int qsthw_unload_module_l(const qsthw_module_handle_t *mod_handle)
{
    return qsthw_close_l(mod_handle);
}

int qsthw_get_properties_l(const qsthw_module_handle_t *mod_handle,
                         struct sound_trigger_properties *properties)
{
    ...
    pthread_mutex_lock(&qsthw_init_lock);
    is_valid = is_valid_qsthw_module_l(qsthw_module);
    pthread_mutex_unlock(&qsthw_init_lock);
...
int qsthw_load_sound_model_l(const qsthw_module_handle_t *mod_handle,
...
int qsthw_unload_sound_model_l(const qsthw_module_handle_t *mod_handle,
                             sound_model_handle_t handle)
{
    int ret = 0;
    qsthw_module_t *qsthw_module = (qsthw_module_t *)mod_handle;
...
int qsthw_start_recognition_l(const qsthw_module_handle_t *mod_handle,
...
int qsthw_stop_recognition_l(const qsthw_module_handle_t *mod_handle,
                           sound_model_handle_t sound_model_handle)
{
    int ret = 0;
    qsthw_module_t *qsthw_module = (qsthw_module_t *)mod_handle;
...
int qsthw_get_param_data_l(const qsthw_module_handle_t *mod_handle,
                         sound_model_handle_t sound_model_handle,
                         const char *param,
                         void *payload,
                         size_t payload_size,
...
int qsthw_set_parameters_l(const qsthw_module_handle_t *mod_handle,
                         sound_model_handle_t sound_model_handle,
                         const char *kv_pairs)
{
    int ret = 0;
...
size_t qsthw_get_buffer_size_l(const qsthw_module_handle_t *mod_handle,
                             sound_model_handle_t sound_model_handle)
{
    int ret = 0;
    qsthw_module_t *qsthw_module = (qsthw_module_t *)mod_handle;
...
int qsthw_read_buffer_l(const qsthw_module_handle_t *mod_handle,
                      sound_model_handle_t sound_model_handle,
                      unsigned char *buf,
                      size_t bytes)
{
...
int qsthw_stop_buffering_l(const qsthw_module_handle_t *mod_handle,
                         sound_model_handle_t sound_model_handle)
{
    int ret = 0;
    qsthw_module_t *qsthw_module = (qsthw_module_t *)mod_handle;
