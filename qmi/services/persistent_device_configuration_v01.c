...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.mpss/4.7/pdc/src/persistent_device_configuration_v01.c#4 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
static const uint8_t pdc_get_feature_ind_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, refresh_mode) - QMI_IDL_OFFSET8(pdc_get_feature_ind_msg_v01, refresh_mode_valid)),
  0x14,
   QMI_IDL_GENERIC_4_BYTE,
...
static const uint8_t pdc_set_feature_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, refresh_mode) - QMI_IDL_OFFSET8(pdc_set_feature_req_msg_v01, refresh_mode_valid)),
  0x14,
   QMI_IDL_GENERIC_4_BYTE,
...
static const qmi_idl_service_message_table_entry pdc_service_command_messages_v01[] = {
  ...
  {QMI_PDC_SET_FEATURE_REQ_V01, QMI_IDL_TYPE16(0, 41), 39}
};
...
static const qmi_idl_service_message_table_entry pdc_service_indication_messages_v01[] = {
  ...
  {QMI_PDC_GET_FEATURE_IND_V01, QMI_IDL_TYPE16(0, 40), 37},
