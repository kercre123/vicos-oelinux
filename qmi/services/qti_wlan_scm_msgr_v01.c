...
GENERAL DESCRIPTION
 ...
 Confidential and Proprietary - Qualcomm Technologies, Inc.
  ...
  $Header: //source/qcom/qct/interfaces/qmi/rel/deploy/scm_msgr/src/qti_wlan_scm_msgr_v01.c#3 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
static const qmi_idl_service_message_table_entry scm_msgr_service_response_messages_v01[] = {
  {QMI_SCM_MSGR_WLAN_ENABLE_RESP_V01, QMI_IDL_TYPE16(0, 1), 26},
  {QMI_SCM_MSGR_WLAN_DISABLE_RESP_V01, QMI_IDL_TYPE16(0, 3), 7},
  {QMI_SCM_MSGR_WLAN_IF_RECONFIG_RESP_V01, QMI_IDL_TYPE16(0, 5), 26},
...
static const qmi_idl_service_message_table_entry scm_msgr_service_indication_messages_v01[] = {
  {QMI_SCM_MSGR_WLAN_IND_V01, QMI_IDL_TYPE16(0, 8), 57}
};
