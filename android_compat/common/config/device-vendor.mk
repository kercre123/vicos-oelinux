...
ifneq (, $(filter $(PRODUCT_LIST), $(TARGET_PRODUCT)))
  ...
  ifeq ($(wildcard $(QC_PROP_ROOT)/common-noship/etc/device-vendor-noship.mk),)
    XML_CONF_PATH := vendor/qcom/proprietary/common/etc
...
# Include the QRD customer extensions for Regional.
$(call inherit-product-if-exists, vendor/qcom/proprietary/qrdplus/Regional/products.mk)
# Include the QRD customer extensions for Regional SP.
$(call inherit-product-if-exists, vendor/qcom/proprietary/qrdplus/RegionalSP/*/products.mk)
endif
...
#POWEROFF_APPS
POWEROFF_APPS := poweroffhandler
POWEROFF_APPS += PowerOffHandlerApp
...
ifeq ($(call is-board-platform-in-list,msm8996 msm8994 msm8992 msm8952 msm8976 msm8937 msm8953),true)
IMS_VT += librcc
endif
...
MM_AUDIO += QRD_SKU5_Bluetooth_cal.acdb
MM_AUDIO += QRD_SKU5_General_cal.acdb
MM_AUDIO += QRD_SKU5_Global_cal.acdb
MM_AUDIO += QRD_SKU5_Handset_cal.acdb
MM_AUDIO += QRD_SKU5_Hdmi_cal.acdb
MM_AUDIO += QRD_SKU5_Headset_cal.acdb
MM_AUDIO += QRD_SKU5_Speaker_cal.acdb
...
MM_CAMERA += libchromatix_imx258_mono_4k_preview_ak7371
MM_CAMERA += libchromatix_imx258_mono_4k_video_ak7371
MM_CAMERA += libchromatix_imx258_mono_default_preview_ak7371
MM_CAMERA += libchromatix_imx258_mono_default_video_ak7371
MM_CAMERA += libchromatix_imx258_mono_hfr_60_ak7371
MM_CAMERA += libchromatix_imx258_mono_hfr_90_ak7371
MM_CAMERA += libchromatix_imx258_mono_hfr_120_ak7371
MM_CAMERA += libchromatix_imx258_mono_zsl_preview_ak7371
MM_CAMERA += libchromatix_imx258_mono_zsl_video_ak7371
...
MM_CAMERA += libchromatix_imx318_default_preview_lc898212xd
MM_CAMERA += libchromatix_imx318_default_video_lc898212xd
...
#OMA_PACKAGES - Packages for OMA DRM, DL and CP
OMA_PACKAGES := libomadrmengine
OMA_PACKAGES += libomadrmutils_jni
OMA_PACKAGES += OmaDrmEngine
OMA_PACKAGES += OmaDrmEngineDemo
OMA_PACKAGES += ConfigurationClient
OMA_PACKAGES += ConfigurationClientDemo
OMA_PACKAGES += OmaDownload
...
QPAY := libQPayJNI
QPAY += com.android.qti.qpay
QPAY += com.android.qti.qpay.xml
endif
endif

QRD_APPS += poweroffhandler
QRD_APPS += PowerOffHandlerApp
...
RIDL_BINS += OriginalGoldenLog.dmc
...
SENSORS += activity_recognition.msmcobalt
...
SENSORS += sensors.msmcobalt
SENSORS += sensors.msm8953
...
WIGIG := wigig-service
WIGIG += WigigSettings
WIGIG += libhardware_wigig
WIGIG += libwigig-service
...
PRODUCT_PACKAGES += $(POWEROFF_APPS)
