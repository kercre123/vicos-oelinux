...
extern "C"
{
   ...
   ****************************************************************************/
   MV_API mvWEF* mvWEF_Initialize( const mvPose6DET* poseVB, const bool loadMapFirst, const bool stateBadAsFail );
   ...
   ****************************************************************************/
   MV_API mvPose6DRT mvWEF_BodyToCameraPose( mvWEF* pObj, mvPose6DET& pose6DET );
   ...
   ****************************************************************************/
   ...
   @param posePairQLen
      Length of posePairQ
   ****************************************************************************/
   MV_API bool mvWEF_EstimateScale( const mvWEFPoseStateTime* poseQ, unsigned int poseQLen,
                                    const mvWEFPoseVelocityTime* wheelQ, unsigned int wheelQLen,
                                    float32_t* scale, posePair* posePairQ, unsigned int* posePairQLen );
#ifdef __cplusplus
}
#endif
