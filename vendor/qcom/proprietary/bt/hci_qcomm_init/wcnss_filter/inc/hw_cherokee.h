...
enum{
    APACHE_VER_0_0_5 = ((PROD_ID_APACHE << 24) | (APACHE_BUILD_VER_0005) | QCA_APACHE_SOC_ID_0005 ),
    APACHE_VER_0_0_6 = ((PROD_ID_APACHE << 24) | (APACHE_BUILD_VER_0006) | QCA_APACHE_SOC_ID_0006 ),
    APACHE_VER_1_0_0 = ((PROD_ID_APACHE << 24) | (APACHE_BUILD_VER_0100) | QCA_APACHE_SOC_ID_0100 ),
    APACHE_VER_1_0_1 = ((PROD_ID_APACHE << 24) | (APACHE_BUILD_VER_0101) | QCA_APACHE_SOC_ID_0101 ),
    APACHE_VER_1_0_2 = ((PROD_ID_APACHE << 24) | (APACHE_BUILD_VER_0102) | QCA_APACHE_SOC_ID_0102 ),
    APACHE_VER_1_0_3 = ((PROD_ID_APACHE << 24) | (APACHE_BUILD_VER_0103) | QCA_APACHE_SOC_ID_0103 ),
    APACHE_VER_1_1_0 = ((PROD_ID_APACHE << 24) | (APACHE_BUILD_VER_0110) | QCA_APACHE_SOC_ID_0110 ),
};
