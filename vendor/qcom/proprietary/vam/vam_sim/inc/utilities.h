...
int draw_bounding_box(uint8_t **pixels, unsigned int stride, unsigned int img_height,
        vaapi_object *pObj, VASimColor color);

int draw_text(uint8_t **pixels, unsigned int stride, unsigned int img_height,
        vaapi_position *pos, const char displayName[VAAPI_NAME_LEN], VASimColor color);
