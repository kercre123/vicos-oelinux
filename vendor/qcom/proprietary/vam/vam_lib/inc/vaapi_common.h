...
{
    vaapi_event_type_none               = 0,  //default type, should always be replaced
    vaapi_event_camera_tamper_detected  = 1,  //The camera is covered, blurry, or moved
    vaapi_event_motion_detected         = 2,  //Motion is detected in the zone
    vaapi_event_line_crossed            = 3,  //An object crossed a line
    vaapi_event_intrusion_detected      = 4,  //An object intrude  an include zone
    vaapi_event_object_counted          = 5,  //An object is counted when in a zone or cross a line
    vaapi_event_loitering_detected      = 6,  //An object stays in a zone for a certain period
    vaapi_event_face_detected           = 7,  //A face is detected
    vaapi_event_face_recognized         = 8,  //A face is recognized
    vaapi_event_object_classified       = 9,  //An object is classified
    vaapi_event_object_detected         = 10, //An object is detected
    vaapi_event_compound_event          = 11, //A client-defined compound event
    vaapi_event_extension_reserved_1    = 12, //Reserved for extension 1
    vaapi_event_extension_reserved_2    = 13, //Reserved for extension 2
    vaapi_event_extension_reserved_3    = 14, //Reserved for extension 3
    vaapi_event_extension_reserved_4    = 15, //Reserved for extension 4
    vaapi_event_extension_reserved_5    = 16, //Reserved for extension 5
    vaapi_event_size                    = 17
};
