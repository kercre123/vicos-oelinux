...
typedef int32_t (*vaapi_event_cb_func)(struct vaapi_event *event, void* usr_data);
typedef int32_t (*vaapi_metadata_cb_func)(struct vaapi_metadata_frame *frame, void* usrData);
typedef int32_t (*vaapi_snapshot_cb_func)(struct vaapi_snapshot_info *info, void *usr_data);
typedef int32_t (*vaapi_frame_processed_cb_func)(uint64_t time_stamp, void *usr_data);
