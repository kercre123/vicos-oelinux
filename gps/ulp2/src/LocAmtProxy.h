...
public:
    ...
    virtual bool reportDrSv(LocGnssSvStatus &svStatus,
                           GpsLocationExtended &locationExtended,
                           void* svExt);
    ...
    virtual bool sendGnssPositionToDr(UlpLocation &location,
                                      GpsLocationExtended &locationExtended,
                                      void* locationExt,
                                      enum loc_sess_status status,
                                      LocPosTechMask loc_technology_mask);
    ...
    virtual bool sendGnssSvToDr(LocGnssSvStatus &svStat,
                                       GpsLocationExtended &locationExtended);
