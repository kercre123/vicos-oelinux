...
bool reportDrSvStatusCb(LocGnssSvStatus &svStatus,
                        GpsLocationExtended &locationExtended)
{
    LocAmtProxy*       pLocAmtProxyRef;
    ...
    ** Report DR SvStatus report as received from AP DR Core
    -- */
    pLocAmtProxyRef->reportDrSv(svStatus,locationExtended, NULL);
...
SIDE EFFECTS
   N/A
===========================================================================*/
bool LocAmtProxy::reportPosition(UlpLocation &location,
                                 GpsLocationExtended &locationExtended,
                                 void* locationExt,
                                 enum loc_sess_status status,
                                 LocPosTechMask loc_technology_mask)
...
SIDE EFFECTS
   N/A
===========================================================================*/
bool LocAmtProxy::sendGnssPositionToDr(UlpLocation &location,
                                       GpsLocationExtended &locationExtended,
                                       void* locationExt,
                                       enum loc_sess_status status,
                                       LocPosTechMask loc_technology_mask)
{
    ...
    return mDRPlugin->injectGpsPosition(location,locationExtended,locationExt,status,loc_technology_mask);
}
...
SIDE EFFECTS
   N/A
===========================================================================*/
bool LocAmtProxy::sendGnssSvToDr(LocGnssSvStatus &svStat,
                                       GpsLocationExtended &locationExtended)
{
    //Send Gnss Sv Status to AP DR for consumption.
    return mDRPlugin->injectGnssSvStatus(svStat,locationExtended);
}
...
SIDE EFFECTS
   N/A
===========================================================================*/
bool LocAmtProxy::reportSv(LocGnssSvStatus &svStatus,
                           GpsLocationExtended &locationExtended,
                           void* svExt)
{
    /*++
    ...
    ** AP DR Solution.
    ...
    ulp_msg_send_sv_external *msg(
        new ulp_msg_send_sv_external(&ulp_data, svStatus,
...
SIDE EFFECTS
   N/A
===========================================================================*/
bool LocAmtProxy::reportDrSv(LocGnssSvStatus &svStatus,
                           GpsLocationExtended &locationExtended,
                           void* svExt)
{
    /*++
