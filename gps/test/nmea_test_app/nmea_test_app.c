    ...
    void *pClientCookie)
{
    ...
    case QMI_LOC_EVENT_NMEA_IND_V02:
        ...
        strncpy(buffer, eventIndPayload.pNmeaReportEvent->nmea,
                 strlen(eventIndPayload.pNmeaReportEvent->nmea) - 2);
        strncpy(buffer + (strlen(eventIndPayload.pNmeaReportEvent->nmea) - 2), "\n", 1);
