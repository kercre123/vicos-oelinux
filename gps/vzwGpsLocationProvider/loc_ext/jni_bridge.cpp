...
static LocGpsLocation       sGpsLocation;
static VzwGpsLocationExt sGpsLocationExt;
static LocGpsStatus       sGpsStatus;
static LocGpsSvStatus     sGpsSvStatus;
static GpsDop          sGpsSvDop;

static LocGpsLocation       sGpsLocationCopy;
static VzwGpsLocationExt sGpsLocationExtCopy;
static LocGpsStatus       sGpsStatusCopy;
static LocGpsSvStatus     sGpsSvStatusCopy;
...
void location_callback(LocGpsLocation* location, VzwGpsLocationExt* ext)
{
...
void sv_status_callback(LocGpsSvStatus* sv_status, GpsDop* sv_dop)
{
    pthread_mutex_lock(&sEventMutex);
