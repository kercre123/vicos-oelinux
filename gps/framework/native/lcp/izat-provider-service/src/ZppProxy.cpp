...
void ZppProxy::handleZppFix(const LocGpsLocation *gpsLocation, LocPosTechMask posTechMask)
{
...
ZppFixMsg::ZppFixMsg(LocGpsLocation *gpsLocation, LocPosTechMask posTechMask) :
