...
SrnDeviceScanDetailsDataItem :: SrnDeviceScanDetailsDataItem (DataItemId Id) :
DataItemBase(Id),
mValidSrnData(false),
mApSrnRssi(-1),
mApSrnTimestamp(0),
...
mErrorCause(-1)
{
    memset (&mApSrnMacAddress, 0, sizeof (mApSrnMacAddress));
}

BtLeDeviceScanDetailsDataItem :: BtLeDeviceScanDetailsDataItem()
:
SrnDeviceScanDetailsDataItem
 (
...
DataItemId BtLeDeviceScanDetailsDataItem :: getId () { return DataItemBase :: getId (); }
DataItemId BtDeviceScanDetailsDataItem :: getId () { return DataItemBase :: getId (); }
...
IDataItemSerializer * BtLeDeviceScanDetailsDataItem :: getSerializer () { if (mSerializer == NULL) mSerializer = new  (std :: nothrow) BtLeDeviceScanDetailsDataItemSerializer (this); return mSerializer; }
IDataItemSerializer * BtDeviceScanDetailsDataItem :: getSerializer () { if (mSerializer == NULL) mSerializer = new  (std :: nothrow) BtDeviceScanDetailsDataItemSerializer (this); return mSerializer; }
...
IDataItemDeSerializer * BtLeDeviceScanDetailsDataItem :: getDeSerializer () { if (mDeSerializer == NULL) mDeSerializer = new  (std :: nothrow) BtLeDeviceScanDetailsDataItemDeSerializer (this); return mDeSerializer; }
IDataItemDeSerializer * BtDeviceScanDetailsDataItem :: getDeSerializer () { if (mDeSerializer == NULL) mDeSerializer = new  (std :: nothrow) BtDeviceScanDetailsDataItemDeSerializer (this); return mDeSerializer; }
...
IDataItemCopier * BtLeDeviceScanDetailsDataItem :: getCopier () { if (mCopier == NULL) mCopier = new  (std :: nothrow) BtLeDeviceScanDetailsDataItemCopier (this); return mCopier; }
IDataItemCopier * BtDeviceScanDetailsDataItem :: getCopier () { if (mCopier == NULL) mCopier = new  (std :: nothrow) BtDeviceScanDetailsDataItemCopier (this); return mCopier; }
...
IDataItemStringifier * BtLeDeviceScanDetailsDataItem :: getStringifier () { if (mStringifier == NULL) mStringifier = new  (std :: nothrow) BtLeDeviceScanDetailsDataItemStringifier (this); return mStringifier; }
IDataItemStringifier * BtDeviceScanDetailsDataItem :: getStringifier () { if (mStringifier == NULL) mStringifier = new  (std :: nothrow) BtDeviceScanDetailsDataItemStringifier (this); return mStringifier; }
