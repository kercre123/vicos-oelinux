...
DATA_ITEM_STRINGIFIER_CTOR(BtLeDeviceScanDetailsDataItemStringifier)
DATA_ITEM_STRINGIFIER_CTOR(BtDeviceScanDetailsDataItemStringifier)
...
DATA_ITEM_STRINGIFIER_DTOR(BtLeDeviceScanDetailsDataItemStringifier)
DATA_ITEM_STRINGIFIER_DTOR(BtDeviceScanDetailsDataItemStringifier)
...
DATA_ITEM_STRINGIFY(BtLeDeviceScanDetailsDataItemStringifier) {
    int32 result = 0;
    ENTRY_LOG();
    do {
        ERROR_CHECK_AND_DOWN_CAST(BtLeDeviceScanDetailsDataItem,BTLE_SCAN_DATA_ITEM_ID);
        valueStr.clear ();
...
DATA_ITEM_STRINGIFY(BtDeviceScanDetailsDataItemStringifier) {
    int32 result = 0;
    ENTRY_LOG();
    do {
        ERROR_CHECK_AND_DOWN_CAST(BtDeviceScanDetailsDataItem,BT_SCAN_DATA_ITEM_ID);
        valueStr.clear ();
