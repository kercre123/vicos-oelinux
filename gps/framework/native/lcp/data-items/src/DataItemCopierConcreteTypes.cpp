...
DATA_ITEM_COPIER_CTOR(BtLeDeviceScanDetailsDataItemCopier)
DATA_ITEM_COPIER_CTOR(BtDeviceScanDetailsDataItemCopier)
...
DATA_ITEM_COPIER_DTOR(BtLeDeviceScanDetailsDataItemCopier)
DATA_ITEM_COPIER_DTOR(BtDeviceScanDetailsDataItemCopier)
...
DATA_ITEM_COPY(BtLeDeviceScanDetailsDataItemCopier) {
    int32 result = -1;
    ENTRY_LOG();
    do {
...
DATA_ITEM_COPY(BtDeviceScanDetailsDataItemCopier) {
    int32 result = -1;
    ENTRY_LOG();
    do {
