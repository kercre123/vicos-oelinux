...
DATA_ITEM_DESERIALIZER_CTOR(BtLeDeviceScanDetailsDataItemDeSerializer)
DATA_ITEM_DESERIALIZER_CTOR(BtDeviceScanDetailsDataItemDeSerializer)
...
DATA_ITEM_DESERIALIZER_DTOR(BtLeDeviceScanDetailsDataItemDeSerializer)
DATA_ITEM_DESERIALIZER_DTOR(BtDeviceScanDetailsDataItemDeSerializer)
...
DATA_ITEM_DESERIALIZE(BtLeDeviceScanDetailsDataItemDeSerializer) {
    UNUSED(ic);
    int32 result = 0;
    ENTRY_LOG();
    do {
...
DATA_ITEM_DESERIALIZE(BtDeviceScanDetailsDataItemDeSerializer) {
    UNUSED(ic);
    int32 result = 0;
    ENTRY_LOG();
    do {
