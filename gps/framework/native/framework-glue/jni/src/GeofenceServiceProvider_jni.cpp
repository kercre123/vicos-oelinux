...
static void TranslateToObject(const LocGpsLocation* location, jobject& locationObject) {
    ...
    if (flags & LOC_GPS_LOCATION_HAS_LAT_LONG) {
    ...
    if (flags & LOC_GPS_LOCATION_HAS_ALTITUDE) {
    ...
    if (flags & LOC_GPS_LOCATION_HAS_SPEED) {
    ...
    if (flags & LOC_GPS_LOCATION_HAS_BEARING) {
    ...
    if (flags & LOC_GPS_LOCATION_HAS_ACCURACY) {
