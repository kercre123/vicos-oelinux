...
import com.qualcomm.location.izatserviceprovider.provider.NetworkLocationProvider;
...
public class NetworkLocationService extends IzatServiceBase {
    ...
    private NetworkLocationProvider mProvider = null;
    ...
    public void onCreate() {
        ...
        mProvider = NetworkLocationProvider.getInstance(getApplicationContext(),
                                                        getLooper());
    }
    ...
    public boolean onUnbind(Intent intent) {
        ...
        if (mProvider != null) {
            ...
            GNPProxy.screenLocations(false);
        }
