...
public class IzatProviderEngine {
    ...
    {
        String mStr = "config_comboNetworkLocationProvider";
        int resId = 0;
        ...
        mComboPackageName = "com.qualcomm.location";

        Log.w (TAG, "mComboPackageName=[" + mComboPackageName + "]");
    ...
    void unsubscribe (String providerName) {
    ...
    )
    {
        ...
        if(positionSource == 0) {
            extras.putString("networkLocationType","cell");
        } else if(positionSource == 1) {
            extras.putString("networkLocationType","wifi");
        }
        ...
        if (mTestAutomationLoggingEnabled) {
            if (VERBOSE_DBG) {
                ...
                Log.v (TAG, "LocTech-Value :: UTC Time: " + location.getTime () +
                       ...
                       ", positionSource: " + location.getExtras().getString("networkLocationType", ""));
            }
        }
        ...
        if (providerName.equals (LocationManager.NETWORK_PROVIDER)) {
            ...
            location.setExtraLocation(
                    Location.EXTRA_NO_GPS_LOCATION, noGpsLocation);
        }
        else {
