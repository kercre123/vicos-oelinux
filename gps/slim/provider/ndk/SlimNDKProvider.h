...
private:
  ...
  */
  ...
  protected:
  //! @brief internal enumberation for batching status
    ...
    BufferTxStatus         m_isBufferInProgress; /** this flag will be set if Buffer data is being sent to client */
    std::list<ASensorEvent> secBufferList;
    /**
...
private:
  ...
  */
   ...
   * @return void.
   */
  bool getBufferedSample(slimServiceEnumT eSensorType, FILE* fd, ASensorEvent *zEventBuffer);
   ...
   */
  bool setBufferState(BufferTxStatus state);
...
public:
  ...
  /** Buffer data thread handle */
  slim_ThreadT m_zBuffThread;
  /**< Structure used to batch buffered samples */
  slimSensorDataStructT  m_zBuffSensorData;
