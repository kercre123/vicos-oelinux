...
private:
    const LocGpsInterface          *m_gps_interface;
public:
    garden_state_initialized(const LocGpsInterface * a_gps_interface);
...
private:
    const LocGpsInterface          *m_gps_interface;
public:
    garden_state_session_off(const LocGpsInterface * a_gps_interface);
...
private:
    const LocGpsInterface          *m_gps_interface;
public:
    garden_state_session_on(const LocGpsInterface * a_gps_interface);
...
private:
    const LocGpsInterface          *m_gps_interface;
public:
    garden_state_gps_off(const LocGpsInterface * a_gps_interface);
...
public:
    garden_app_session_tracker(const LocGpsInterface *a_gps_interface);
