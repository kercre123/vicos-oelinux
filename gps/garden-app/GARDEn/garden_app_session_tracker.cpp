...
garden_state_initialized::garden_state_initialized(const LocGpsInterface * a_gps_interface): garden_state_base(),
...
garden_state_session_off:: garden_state_session_off(const LocGpsInterface * a_gps_interface): garden_state_base(),
                            m_gps_interface(a_gps_interface)
{
}
...
garden_state_session_on::garden_state_session_on(const LocGpsInterface * a_gps_interface): garden_state_base(),
                            m_gps_interface(a_gps_interface)
{
}
...
bool  garden_state_session_on::state_action()
{
    ...
    m_gps_interface->set_position_mode (LOC_GPS_POSITION_MODE_MS_BASED,
                                     LOC_GPS_POSITION_RECURRENCE_PERIODIC,
                                     1000,
                                     ULP_HORZ_ACCURACY_HIGH,
                                     1000);
    rc = m_gps_interface->start ();
    if(0 != rc){
...
garden_state_gps_off::garden_state_gps_off(const LocGpsInterface * a_gps_interface): garden_state_base(),
                        m_gps_interface(a_gps_interface)
{
}
...
garden_app_session_tracker::garden_app_session_tracker(const LocGpsInterface * a_gps_interface):
